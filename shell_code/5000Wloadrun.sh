...
function prepare_conf()
{
    ...
    if [ "$1" = "all" ];then
       ...
       echo "cp -P $conf_dir/sfx_aerospike/$1_$default_conf $conf_dir/$default_conf"
       cp -P $conf_dir/sfx_aerospike/$1_$default_conf $conf_dir/$default_conf
    fi
}
...
while getopts :a:b:l:n:m:d:h:c:w:t:r:o:s: vname 
do
    case "$vname" in
